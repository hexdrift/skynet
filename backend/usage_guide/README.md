...
This guide is for **clients** who want to submit optimization jobs to the Skynet service. For service operators, see the [main README](../README.md).
...
Datasets live at the repo root in `data/`. From a notebook in this directory:
```python
import json
