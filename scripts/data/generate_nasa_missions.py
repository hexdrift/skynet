...
MISSIONS: list[tuple[str, str, int, str, str, str]] = [
    # Mercury program (1958-1963) — first US human spaceflight program.
    ...
    # Gemini program (1965-1966) — rendezvous, docking, and EVA practice.
    ...
    # Apollo program (1961-1972) — crewed lunar exploration.
    ...
    # Skylab and Apollo-Soyuz (1973-1975) — first US space station.
    ...
    # Mariner program — Mercury, Venus, Mars flybys.
    ...
    # Pioneer program — outer-solar-system reconnaissance.
    ...
    # Viking program — first Mars landers.
    ...
    # Voyager program — Grand Tour of the outer planets.
    ...
    # Space Shuttle program (1981-2011) — partial selection of milestones and disasters.
    ...
    # Galileo, Magellan, Cassini, Juno — outer-solar-system orbiters.
    ...
    # Lunar reconnaissance and small missions.
    ...
    # Sample-return and asteroid/comet missions.
    ...
    # Great Observatories and follow-on telescopes.
    ...
    # Earth observation and heliophysics.
    ...
    # ISS expeditions and assembly notes.
