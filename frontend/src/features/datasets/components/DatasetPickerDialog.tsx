  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="w-[min(34rem,94vw)] max-w-[min(34rem,94vw)] sm:max-w-lg" dir="rtl">
        ...
        <div className="max-h-[min(24rem,55vh)] space-y-1.5 overflow-y-auto">
          {loading ? (
            ...
            filtered.map((dataset) => {
              ...
              return (
                <button
                  ...
                  className="group flex w-full items-center gap-3 rounded-lg border border-[#DDD4C8]/60 bg-gradient-to-b from-white/95 to-[#F8F4EF] px-3 py-2.5 text-start transition-[border-color,box-shadow] duration-200 hover:border-[#C8B9A8]/70 hover:shadow-[0_2px_10px_rgba(28,22,18,0.06)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring/50"
                >
