...
export const trajectoryMessages = {
  ...
  "trajectory.detail.pareto_title": "דוגמאות אימות",
  ...
  "trajectory.node.section.prompt.explain": "הוראות הסוכן עבור המועמד הזה — הטקסט שמודל הרפלקציה מכוונן כדי לשפר את הביצועים.",
  ...
  "trajectory.chat.recorded_label.explain": "תיעוד קפוא של חילופי ההודעות שהוצגו למועמד — לקריאה בלבד, לא שיחה פעילה.",
