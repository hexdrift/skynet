...
export function DatasetStep({ w }: { w: SubmitWizardContext }) {
  const { parsedDataset, datasetFileName, fileInputRef, handleFileUpload, columnRoles, setColumnRoles } = w;

  return (
    <Card className=" border-border/50 bg-card/80 backdrop-blur-xl shadow-lg" data-tutorial="wizard-step-2">
      <CardHeader>
