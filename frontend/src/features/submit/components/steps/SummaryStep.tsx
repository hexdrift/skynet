...
import {
  User, Code, Tag, Layers, Component, Target, FileText,
  Columns, Shuffle, Search, Database, Cpu,
} from "lucide-react";
...
export function SummaryStep({ w }: { w: SubmitWizardContext }) {
  const {
    summaryTab, setSummaryTab, summaryCodeTab, setSummaryCodeTab,
    jobName, jobType, moduleName, optimizerName,
    datasetFileName, parsedDataset, columnRoles, split, shuffle,
    modelConfig, secondModelConfig, generationModels, reflectionModels,
    autoLevel, maxBootstrappedDemos, maxLabeledDemos, numTrials, minibatch, minibatchSize,
