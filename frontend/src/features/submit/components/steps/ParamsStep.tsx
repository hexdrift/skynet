  ...
  return (
    ...
    >
      <CardHeader>
        ...
        <CardDescription>מודול, חלוקת הנתונים והגדרותיו</CardDescription>
      </CardHeader>
      <CardContent className="space-y-5">
        <div className="space-y-2" data-tutorial="module-selector">
          <Label>
            <HelpTip text={tip("module.choice")}>מודול</HelpTip>
          </Label>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                <div className="space-y-1">
                  <Label htmlFor="split-train" className="flex items-center gap-1.5 text-xs">
                    ...
                    <HelpTip text={tip("data.split.train")}>אימון</HelpTip>
                  </Label>
                  <NumberInput
                    id="split-train"
                    step={0.05}
                ...
                <div className="space-y-1">
                  <Label htmlFor="split-val" className="flex items-center gap-1.5 text-xs">
                    ...
                    <HelpTip text={tip("data.split.val")}>אימות</HelpTip>
                  </Label>
                  <NumberInput
                    id="split-val"
                    step={0.05}
                ...
                <div className="space-y-1">
                  <Label htmlFor="split-test" className="flex items-center gap-1.5 text-xs">
                    ...
                    <HelpTip text={tip("data.split.test")}>בדיקה</HelpTip>
                  </Label>
                  <NumberInput
                    id="split-test"
                    step={0.05}
          ...
          <div className="grid grid-cols-2 gap-3" data-tutorial="gepa-params">
            <div className="space-y-1.5">
              <Label className="text-xs">
                <HelpTip text={tip("submit.reflection_minibatch")}>גודל מדגם לרפלקציה</HelpTip>
              </Label>
              <NumberInput
                min={1}
                max={20}
            ...
            <div className="space-y-1.5">
              <Label className={cn("text-xs", autoLevel && "text-muted-foreground/50")}>
                <HelpTip text={tip("submit.eval_rounds")}>מקסימום סבבי הערכה</HelpTip>
              </Label>
              <NumberInput
                min={1}
                max={50}
            ...
            <div className="col-span-2 flex items-center justify-between">
              <Label className="text-sm cursor-pointer">
                <HelpTip text={tip("submit.merge")}>מיזוג מועמדים</HelpTip>
              </Label>
