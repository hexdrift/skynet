...
export const submitMessages = {
  ...
  "submit.validation.split_too_small": `סט הנתונים קטן מדי כדי להריץ ${TERMS.optimization} — נדרשות לפחות דוגמאות ל${TERMS.splitVal} או ל${TERMS.splitTest}`,
  ...
  "auto.features.submit.hooks.use.code.agent.literal.2": "כותב פרומפט התחלתי…",
  ...
  "auto.features.submit.hooks.use.code.agent.literal.5": "עורך פרומפט התחלתי…",
  ...
  "auto.features.submit.hooks.use.code.agent.template.3":
    "האימות מצא שגיאות בקוד שנכתב. תקן את הפרומפט ההתחלתי ואת פונקציית המדידה כדי שיעברו אימות, תוך שמירה שהשדות ממופים לעמודות של ה{p1}.",
