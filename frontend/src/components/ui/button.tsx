...
"hover:bg-accent hover:text-accent-foreground",
 ...
 "pill-sm": "h-8 rounded-full px-5 text-xs font-semibold has-[>svg]:px-3.5 hover:shadow-[0_0_12px_rgba(61,46,34,0.15)]",
 "pill-lg": "h-12 rounded-full px-9 text-base font-semibold has-[>svg]:px-6 hover:shadow-[0_0_20px_rgba(61,46,34,0.25)]",
