...
export default function LoginPage() {
 ...
 <Label htmlFor="login-username" className="text-[13px] font-medium text-muted-foreground">
 שם משתמש
 </Label>
 <Input
 id="login-username" value={username}
 onChange={(e) => setUsername(e.target.value)}
 placeholder="הזן שם משתמש" autoFocus dir="rtl"
 ...
 <Button
 type="submit" className="w-full h-11 text-base mt-2"
 size="lg"
