            ...
            <div className="flex flex-wrap items-start justify-between gap-4">
              <div className="space-y-2 min-w-0">
                ...
                <code
                  ...
                  tabIndex={0}
                  onClick={() => {
                    navigator.clipboard.writeText(job.optimization_id);
                      ...
                      <div className="space-y-1.5">
                        ...
                        <div className="rounded-lg bg-muted/40 p-2.5 pe-8 relative group" dir="ltr">
                          <code className="text-xs font-mono break-all">
                            POST {process.env.NEXT_PUBLIC_API_URL ?? "http://localhost:8000"}/serve/
                            {id}
                          </code>
                          <CopyButton
                            text={`${process.env.NEXT_PUBLIC_API_URL ?? "http://localhost:8000"}/serve/${id}`}
